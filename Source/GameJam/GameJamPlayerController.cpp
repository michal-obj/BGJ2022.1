...
void AGameJamPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AGameJamPlayerController::OnResetVR);
}

void AGameJamPlayerController::OnResetVR()
{
...
void AGameJamPlayerController::MoveToMouseCursor()
{
	...
	{
		if (AGameJamCharacter* MyPawn = Cast<AGameJamCharacter>(GetPawn()))
		{
